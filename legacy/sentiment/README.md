# ⚠️ Legacy – FeelMap Sentiment App

> The LangGraph agent now exposes sentiment analysis through the
> `analyzeSentiment` tool. Keep this Streamlit app for archival or
> standalone use only.
