# ⚠️ Legacy – Job Application Tracker

> This Streamlit/Gmail workflow remains for reference only. The active
> implementation now lives in the LangGraph agent (`adapters/server_langgraph.js`)
> via the Node scanner service and the jobs tools.
